...
public class PHPArrayReader {
    private Integer pointer;
    private StringBuilder phpArraySerial;
    private Map<String, Object> fieldMap;

    public PHPArrayReader(String phpArraySerial) {
        this.pointer = 0;
    ...
    private Map<String, Object> getArray(String[] options) throws PHPArrayReaderExeption {
    ...
    private boolean isOption(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        return optionExists(option, fieldMap);
    }

    public Boolean isOptionString(String option) throws PHPArrayReaderExeption {
        return isOptionString(option, fieldMap);
    }

    public Boolean isOptionString(String[] options) throws PHPArrayReaderExeption {
        return isOptionString(options[options.length - 1], getArray(options));
    }

    private Boolean isOptionString(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        optionExists(option, fieldMap);
        return getOption(option).getClass() == String.class;
    }

    public Boolean isOptionBoolean(String option) throws PHPArrayReaderExeption {
        return isOptionBoolean(option, fieldMap);
    }

    public Boolean isOptionBoolean(String[] options) throws PHPArrayReaderExeption {
        return isOptionBoolean(options[options.length - 1], getArray(options));
    }

    private Boolean isOptionBoolean(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        optionExists(option, fieldMap);
        return getOption(option, fieldMap).getClass() == Boolean.class;
    }

    public Boolean isOptionArray(String option) throws PHPArrayReaderExeption {
        return isOptionArray(option, fieldMap);
    }

    public Boolean isOptionArray(String[] options) throws PHPArrayReaderExeption {
        return isOptionArray(options[options.length - 1], getArray(options));
    }

    private Boolean isOptionArray(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        optionExists(option, fieldMap);
        return getOption(option, fieldMap).getClass() == HashMap.class;
    }

    public Object getOption(String option) throws PHPArrayReaderExeption {
        return getOption(option, fieldMap);
    }

    public Object getOption(String[] options) throws PHPArrayReaderExeption {
        return getOption(options[options.length - 1], getArray(options));
    }

    private Object getOption(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        optionExists(option, fieldMap);
        return fieldMap.get(option);
    }

    public String getOptionString(String option) throws PHPArrayReaderExeption {
        return getOptionString(option, fieldMap);
    }

    public String getOptionString(String[] options) throws PHPArrayReaderExeption {
        return getOptionString(options[options.length - 1], getArray(options));
    }

    private String getOptionString(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        if (isOptionString(option, fieldMap)) return (String) getOption(option, fieldMap);
        throw new PHPArrayReaderExeption("Is not a String");
    }

    public Boolean getOptionBoolean(String option) throws PHPArrayReaderExeption {
        return getOptionBoolean(option, fieldMap);
    }

    public Boolean getOptionBoolean(String[] options) throws PHPArrayReaderExeption {
        return getOptionBoolean(options[options.length - 1], getArray(options));
    }

    private Boolean getOptionBoolean(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        if (isOptionBoolean(option, fieldMap)) return (Boolean) getOption(option, fieldMap);
        throw new PHPArrayReaderExeption(("is not a boolean"));
    }

    public Map<String, Object> getOptionArray(String option) throws PHPArrayReaderExeption {
        return getOptionArray(option, fieldMap);
    }

    public Map<String, Object> getOptionArray(String[] options) throws PHPArrayReaderExeption {
        return getOptionArray(options[options.length - 1], getArray(options));
    }

    private Map<String, Object> getOptionArray(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        if (isOptionArray(option, fieldMap)) return (Map<String, Object>) getOption(option, fieldMap);
        throw new PHPArrayReaderExeption("Is not an array");
    }

    private boolean optionExists(String option) throws PHPArrayReaderExeption {
        return optionExists(option, fieldMap);
    }

    private boolean optionExists(String[] options) throws PHPArrayReaderExeption {
        return optionExists(options[options.length - 1], getArray(options));
    }

    private boolean optionExists(String option, Map<String, Object> fieldMap) throws PHPArrayReaderExeption {
        if (fieldMap.containsKey(option) == false) {
            throw new PHPArrayReaderExeption("Option does not exist");
        }
        return true;
    }
